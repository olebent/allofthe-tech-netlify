class Level extends Phaser.Scene {
  ...
  class Level1 extends Level {
    constructor() {
      super('Level1')
      this.heights = [4, 7, 5, null, 5, 4, null, 4, 4,3];
  ...
  class Level2 extends Level {
    constructor() {
      super('Level2')
      this.heights = [5, 4, null, 4, 6, 4, 6, 5, 5,4];
  ...
  class Level3 extends Level {
    constructor() {
      super('Level3')
      this.heights = [6, null, 6, 4, 6, 4, 5, null, 4,3];
      this.weather = 'night';
    }
  }
  ...
  class Level4 extends Level {
    constructor() {
      super('Level4')
      this.heights = [4, null, 3, 6, null, 6, null, 5, 4,3];
  ...
  class Credits extends Phaser.Scene {
    ...
    create() {
          gameState.bgColor = this.add.rectangle(0,0,config.width,config.height, 0x0aaff).setOrigin(0,0);
      ...
      this.add.text(125, 50, "Bra jobba" , { fill: '#4D39E0', fontSize: '45px' });
  ...
  const config = {
    ...
    scene: [ Level1, Level2, Level3, Level4,Level5,Credits] //Level1, Level2, Level3, Level4,
  };
