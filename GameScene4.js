class GameScene extends Phaser.Scene {
    ...
    create() {
      ...
      for(let i = 1; i < 10; i++){
        ...
        // Creates a circle that is completely transparent
        let currentCircle = this.add.circle(randomCoord.x + 10, randomCoord.y + 15, 15, 0x4D39E0, 0)
        ...
        this.tweens.add(
          {
            ...
            onComplete: function() {
              ...
              gameState.score.setText(`  Riktig: ${gameState.correct}\nFeil: ${gameState.incorrect}`);
      ...
      gameState.textAlert = this.add.text(65, 520, '  Husk rekkefølgen \n   på tallene!', { fill: '#4D39E0', fontSize: '25px' }) 
